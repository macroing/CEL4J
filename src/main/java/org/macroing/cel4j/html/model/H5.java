...
/**
 * A {@code H5} represents a {@code h5} element in HTML source code.
 * <p>
 ...
 */
public final class H5 extends ContentElement {
	/**
	 * The initial {@link Display} associated with a {@code H5} instance.
	 */
	public static final Display DISPLAY_INITIAL = Display.BLOCK;
	
	/**
	 * The name associated with a {@code H5} instance.
	 */
