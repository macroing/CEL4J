...
/**
 * An {@code H6} represents an {@code h6} element in HTML source code.
 * <p>
 ...
 */
public final class H6 extends ContentElement<Element, Content<Element>> {
	/**
	 * The initial {@link Display} associated with an {@code H6} instance.
	 */
	public static final Display DISPLAY_INITIAL = Display.BLOCK;
	
	/**
	 * The name associated with an {@code H6} instance.
	 */
	 ...
	 * 
	 * @param content the {@link Content} associated with this {@code H6} instance
	 * @throws NullPointerException thrown if, and only if, {@code content} is {@code null}
	 */
	public H6(final Content<Element> content) {
