...
public abstract class ContentElement extends Element {
	 ...
	 */
	protected ContentElement(final String name) {
	 ...
	 */
	protected ContentElement(final String name, final Display display) {
		this(name, display, new Text());
	}
	 ...
	 */
	protected ContentElement(final String name, final Display display, final Content content) {
		super(name, display);
