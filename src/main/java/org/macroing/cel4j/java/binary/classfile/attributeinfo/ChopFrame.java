...
//	TODO: Add Javadocs!
	...
	public boolean equals(final Object object) {
		if(object == this) {
			...
			return false;
		} else if(!Objects.equals(Integer.valueOf(this.frameType), Integer.valueOf(ChopFrame.class.cast(object).frameType))) {
			return false;
		} else if(!Objects.equals(Integer.valueOf(this.offsetDelta), Integer.valueOf(ChopFrame.class.cast(object).offsetDelta))) {
			return false;
		} else {
			return true;
		}
