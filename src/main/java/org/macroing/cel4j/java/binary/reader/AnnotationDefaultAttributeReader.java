...
final class AnnotationDefaultAttributeReader implements AttributeInfoReader {
	public AnnotationDefaultAttributeReader() {
	...
	public boolean isSupported(final String name) {
		return name.equals(AnnotationDefaultAttribute.NAME);
	}
