...
import org.macroing.cel4j.java.binary.classfile.string.Result;
import org.macroing.cel4j.java.binary.classfile.string.ReturnDescriptor;
...
final class JMethod {
	...
	public String getName() {
		return ConstantUTF8Info.findByNameIndex(this.classFile, this.methodInfo).getString();
	}
